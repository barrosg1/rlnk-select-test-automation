...
%(ending)s
    ...
    # open('templates/report.html', 'r').read().encode('utf-8')
...
class HTMLTestRunner(Template_mixin):
    ...
    def _generate_report(self, result):
        ...
        report = self.REPORT_TEMPLATE % dict(
            test_list=''.join(rows),
    ...
    def _generate_report_test(self, rows, cid, tid, n, t, o, e):
        ...
        desc = doc and ('%s: %s' % (name, doc)) or name
        tmpl = has_output and self.REPORT_TEST_WITH_OUTPUT_TEMPLATE or self.REPORT_TEST_NO_OUTPUT_TEMPLATE
